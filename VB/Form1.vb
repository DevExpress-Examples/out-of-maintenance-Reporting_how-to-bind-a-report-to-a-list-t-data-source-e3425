...
Namespace docITypedList
	Partial Public Class Form1
		...
		Private Function CreateData() As IList(Of Supplier)
		...
		Private Function CreateProduct(ByVal supplierID As Integer, ByVal productName As String) As Product
			...
			product.AddRange(New OrderDetail() { New OrderDetail(product.ProductID, random.Next(0, 100)), _ 
				New OrderDetail(product.ProductID, random.Next(0, 100)), New OrderDetail(product.ProductID, random.Next(0, 100)) })
